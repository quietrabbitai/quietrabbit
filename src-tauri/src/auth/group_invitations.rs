...
/// building that creation flow is not this item's scope (there is no
/// `groups` table/creation command anywhere in this codebase today; flagged
/// in this item's handoff as a gap, same shape as items.id=289 turning out
/// to be a hidden prerequisite for this item).
