...
static SCHEMA_FILES: &[SchemaFile] = &[
    ...
    SchemaFile { prefix: "outputs", version: 6,
        sql: include_str!("../../schema/outputs_006.sql") },
    SchemaFile { prefix: "outputs", version: 7,
        sql: include_str!("../../schema/outputs_007.sql") },
    SchemaFile { prefix: "outputs", version: 8,
        sql: include_str!("../../schema/outputs_008.sql") },
    SchemaFile { prefix: "outputs", version: 9,
